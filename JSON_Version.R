...
query_name <- Sys.getenv("SPARQL_QUERY_NAME")
query_file <- jsonlite::fromJSON("~/GitHub/DDW_Steward_Check/SPARQL/SPARQL_UnFilledColumnDesc.JSON")
...
query_raw <- queries_list[queries_list$name == paste0(query_name),"body"]
query_raw <- query_file$query
